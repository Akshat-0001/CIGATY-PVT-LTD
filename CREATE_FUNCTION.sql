-- ⚠️ RUN THIS IN SUPABASE SQL EDITOR TO FIX THE 404 ERROR!
...
BEGIN
  IF EXISTS (
    ...
    RAISE NOTICE '✅ SUCCESS! Function created successfully.';
  ELSE
    RAISE EXCEPTION '❌ FAILED! Function was not created.';
  END IF;
END $$;
